<template>
  <component :is="type" class="index">
    ...
    <wrapper>
      <heading level="h1">FAS Design System</heading>
      <text-style>Based on <a href="https://vueds.com">Vue Design System</a>, an open-source tool for building design systems with Vue.js. It provides you and your team a set of organized tools, patterns &amp; practices. It works as the foundation for your application development.</text-style>
    </wrapper>
  </component>
</template>
